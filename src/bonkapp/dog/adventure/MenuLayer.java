...
public class MenuLayer extends CCLayer {
	...
	public MenuLayer(boolean playMusic)
	{
		...
		CCMenu menu = CCMenu.menu(play, sound, music, help, rate, more);
	...
	public void onMore(Object sender)
	 { 
		...
		try 
		{ 
			context.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("market://search?q=pub:bonkapp"))); 
		} 
		catch(Exception e)
		{ 
			context.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("http://play.google.com/store/apps/search?q=pub:bonkapp"))); 
